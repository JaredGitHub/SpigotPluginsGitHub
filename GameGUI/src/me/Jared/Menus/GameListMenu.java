...
public class GameListMenu extends Menu
{
	...
	public void setMenuItems()
	{
		...
		ConfigManager.iconCreate(new ItemStack(Material.DIAMOND), ChatColor.GOLD + "Survival Games", inventory, 2);
		ConfigManager.iconCreate(new ItemStack(Material.DIAMOND), ChatColor.GREEN + "Gun Game", inventory, 3);
		ConfigManager.iconCreate(new ItemStack(Material.DIAMOND), ChatColor.DARK_GREEN + "WarZ", inventory, 4);
		ConfigManager.iconCreate(new ItemStack(Material.DIAMOND), ChatColor.RED + "Team Deathmatch", inventory, 5);
		ConfigManager.iconCreate(new ItemStack(Material.DIAMOND), ChatColor.GOLD + "Duel", inventory, 6);
